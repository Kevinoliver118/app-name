            ...
            <div class="col-lg-6">
              <div class="card-body p-md-5 mx-md-4">
                ...
                <div class="text-center">
                  <img src="../../../public/assets/img/konoha.jpg" style="width: 185px;" alt="">
                ...
                <form action="<?php echo e(route('register')); ?>" method="post">
                  ...
                  <div class="form-outline mb-4">
                    <label class="form-label" for="form2Example11">Confirmar Correo</label>
                    <input type="email" name="email_confirmation" id="form2Example11" class="form-control"
                      placeholder="ingresa tu correo" />
                  </div>
                  ...
                  <div class="d-flex align-items-center justify-content-center pb-4">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-danger">Login</a>
                  </div>
...
</html><?php /**PATH C:\xampp\htdocs\app-name\resources\views/auth/register.blade.php ENDPATH**/ ?>